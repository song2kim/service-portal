            ...
            <div className="topic">
                <div className="topic__inner">
                    <div className="topic__left">
                        ...
                        <p className="topic__subtitle">We make our universe a better place that changes the way you operates in the IT infrastructures across on-premises and multiclouds.</p>
                    </div>
                    <img className="topic__right topic__thumbnail" src="/assets/images/img_home_topic.svg" alt="topic" />
                </div>
                    ...
                    (item, index) => (
                        <div className="help__item" key={index}>
                            ...
                            <div className="help__right ">
                                ...
                                <LinkText href={item.href}>{item.linkText}</LinkText>
                            </div>
                        </div>
                    )
                    ,
